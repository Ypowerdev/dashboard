 ...
 * Таблица для хранения данных мониторинга Техники на объектах: monitor_technica
 * Записи хранят План/Факт по наличию техники на объекте в тот или иной день.
 */
class MonitorTechnica extends Model
{
    // use SoftDeletes;

    protected $table = 'monitor_technica';
    protected $fillable = [
        'count_plan',
        'count_fact',
        'object_id',
        'user_id',
        'master_code_dc',
        'month_plan', //todo: не использовать!!! К удалению из БД
        'date'
    ];
